    ...
    <form method="post" action="" name="pages">
        ...
        <table id="tableForm">
            ...
            <tr>
                ...
                <td> <input type="submit" name="sub" value="Save" /> &nbsp;  <input type="button" name="" onclick="javascript:window.location = 'admin.php';" value="back to lists" /> </td>
