...
class Paginator{
	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1)
		    $pagination.= "<li class='page-item active'><a class='page-link' href='".$path."$this->_instance=$prev"."$ext'>« </a></li>";
		else
		    $pagination.= "<li class='page-item active'><a class='page-link'><span class='disabled'>« </span></a></li>";   
		...
		if ($counter == $this->_page)
		    $pagination.= "<li class='page-item active'><a class='page-link'><span class='current'>$counter</span></a></li>";
		else
		...
		if ($this->_page < $counter - 1)
		    $pagination.= "<li class='page-item active'><a class='page-link' href='".$path."$this->_instance=$next"."$ext'> »</a></li>";
		else
		    $pagination.= "<li class='page-item active'><a class='page-link'><span class='disabled'> »</span></a></li>";
		    $pagination.= "</ul></nav>\n";       
		}
